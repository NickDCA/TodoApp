...
function displayAllTodos() {
    const projects = (0,_project__WEBPACK_IMPORTED_MODULE_0__.getProjects)();
...
function createTodo({ title, description, priority, dueDate, projectName }) {
    const todo = new _todo__WEBPACK_IMPORTED_MODULE_1__["default"](title, description, priority, dueDate, projectName);
    const projects = (0,_project__WEBPACK_IMPORTED_MODULE_0__.getProjects)();
    ...
    if (projects.some((p) => p.name === projectName)) {
        ...
        const newProject = new _project__WEBPACK_IMPORTED_MODULE_0__["default"](projectName, [todo]);
...
function updateTodo(title, description, priority, projectName) {
    ...
    const updatedTodo = new _todo__WEBPACK_IMPORTED_MODULE_1__["default"](title, description, priority, projectName);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ configTodoForm)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/format.mjs");
/* harmony import */ var _displayAllTodos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayAllTodos */ "./src/js/displayAllTodos.js");
/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project */ "./src/js/project.js");
/* harmony import */ var _todoCRUD__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todoCRUD */ "./src/js/todoCRUD.js");





function configTodoForm() {
    const formModal = document.querySelector('dialog');
    const projectSelect = document.querySelector('#project');

    const projects = (0,_project__WEBPACK_IMPORTED_MODULE_1__.getProjects)();
    ...
    createProjectOption.value = 'newProject';
    ...
    createProjectOption.addEventListener('click', () => {
        ...
        newProjectInput.classList.toggle('input__new-project--active');
    });
...
function handleSubmitInputs() {
    ...
    const todoDueDateFormatted = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(
    ...
    (0,_todoCRUD__WEBPACK_IMPORTED_MODULE_2__.createTodo)(newTodo);
    (0,_displayAllTodos__WEBPACK_IMPORTED_MODULE_0__["default"])();
}
...
/* harmony import */ var _js_displayAllTodos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/displayAllTodos */ "./src/js/displayAllTodos.js");
...
/* harmony import */ var _js_todoCRUD__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/todoCRUD */ "./src/js/todoCRUD.js");
/* harmony import */ var _js_todoForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/todoForm */ "./src/js/todoForm.js");
...
const projects = (0,_js_project__WEBPACK_IMPORTED_MODULE_1__.getProjects)();
if (projects.length === 0) {
    const defaultTodo = {
        title: 'Default Todo',
        description: 'This is a default example todo!',
        dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.format)(new Date(), 'dd-MM-yyyy'),
        priority: 'low',
        projectName: 'Default',
    };
    (0,_js_todoCRUD__WEBPACK_IMPORTED_MODULE_3__.createTodo)(defaultTodo);
}
...
(0,_js_displayAllTodos__WEBPACK_IMPORTED_MODULE_0__["default"])();
(0,_js_todoForm__WEBPACK_IMPORTED_MODULE_4__["default"])();
