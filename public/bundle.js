...
class Todo {
    constructor(title, description, priority, project) {
        ...
        this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date(), 'dd-MM-yyyy');
...
function handleSubmitInputs() {
    ...
    const todoDueDateFormatted = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(
...
/* harmony import */ var _js_todoForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/todoForm */ "./src/js/todoForm.js");
...
const defaultProject = new _js_project__WEBPACK_IMPORTED_MODULE_1__["default"]('Default', [
    new _js_todo__WEBPACK_IMPORTED_MODULE_2__["default"]('Default', 'Default Todo', 'low', 'Default'),
]);
...
function addTodo(title, description, priority, projectName) {
    const todo = new _js_todo__WEBPACK_IMPORTED_MODULE_2__["default"](title, description, priority, projectName);

    if (projects.some((p) => p.name === projectName)) {
        const existingProject = projects.find((p) => p.name === projectName);
        existingProject.todos.push(todo);
    } else {
        const newProject = new _js_project__WEBPACK_IMPORTED_MODULE_1__["default"](projectName, [todo]);
...
function updateTodo(title, description, priority, projectName) {
    ...
    const updatedTodo = new _js_todo__WEBPACK_IMPORTED_MODULE_2__["default"](title, description, priority, projectName);
...
(0,_js_todoForm__WEBPACK_IMPORTED_MODULE_3__["default"])();
